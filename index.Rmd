...
The average compensation with high skills job level are $76,232.19, $61,766.00, and $74,333.33 for 2016, 2017, and 2018 respectively. The average compensation without high skills job level are $69,880.79, $61,766.00, and $66,594.64 for 2016, 2017, and 2018 respectively. The data for the average with high skills is difficult to analyze since 2017 does not contain any high skill data at all. The high skills job comprised of roles that include senior and manager. We also have to take the data with a grain of salt since the data for each year were taken from different companies that control a different portion of the market. With all that being said we can see that there is a decrease in salary from 2016 to 2017 and an increase in 2018 but is still lower than in 2016.

###  Converting to RPP
The BEA stated that Wichita Regional Price Parity (RPP) is 90.2. We will make an assumption that the RPP stays at the same rate. When we convert the data to match the RPP the average compensation with high skills job level increases to $84,702.43, $68,628.89, and $82,592.59 for 2016, 2017, and 2018 respectively. The average compensation without high skills job level is $77,645.32, $68,628.89, and $73,994.05 for 2016, 2017, and 2018 respectively.
