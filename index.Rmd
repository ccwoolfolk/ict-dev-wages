...
get('plot_salaryByLocation', envir=env2017) + scale_y_continuous(label=comma) + theme(axis.text = element_text(size=12))
```
...
get('plot_rppAdjustedSalaryByLocation', envir=env2017) + scale_y_continuous(label=comma) + theme(axis.text = element_text(size=12))
```
